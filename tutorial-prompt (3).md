...
A single `<h1 class="dash-title">Davis Little's Dashboard</h1>` at the very top of the body. Styled as:
...
- The page opens with a gradient `Davis Little's Dashboard` headline at the top.
