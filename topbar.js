...
(function () {
  ...
  const TOPBAR_SUPABASE_URL = 'https://onggaqxuriybodtyavsd.supabase.co';
  const TOPBAR_SUPABASE_KEY = 'sb_publishable__D6jwlREF6WQiFeFZe6j1A_0N59qzPr';
...
`;
  ...
  async function pushWaterMergedToSupabase(localWater) {
    if (window.location.pathname.endsWith('water.html')) return;
